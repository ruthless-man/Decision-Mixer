...
class DecisionTransformer(TrajectoryModel):
    ...
    def forward(self, states, actions, returns_to_go, timesteps, attention_mask=None,device=None):
        ...
        mask_ave=transformer_outputs['mask_ave']
        ...
        return None, action_preds, None,mask_ave

    def get_action(self, states, actions, returns_to_go, timesteps,**kwargs):
        # we don't care about the past rewards in this model

        states = states.reshape(1, -1, self.state_dim)#1，1，17
        actions = actions.reshape(1, -1, self.act_dim)#1，1，6
        returns_to_go = returns_to_go.reshape(1, -1, 1)#1，1，1，
        ...
        state_preds, action_preds, return_preds,_ = self.forward(
